...
export default function GithubWindow() {
  return (
    <div class='flex flex-col items-center justify-center h-full w-full rounded-b-md text-center'>
        ...
        <a href='https://github.com/khalilMounchit' class='gradient-text font-bold text-2xl mb-4 hover:scale-105 transition' target='_blank'>github.com/khalilMounchit</a>
    </div>
  )
}
