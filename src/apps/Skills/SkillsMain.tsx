...
export default function SkillsMain() {
    ...
    const [selected, setSelected] = useState(t("languages"));
  return (
    <div class='h-full w-full md:rounded-b-md'>
        <div class='p-10 gap-5 text-center text-white w-full flex flex-col pt-20 items-center justify-center'>
            <Animated animationIn="fadeInDown" animationOut="fadeOut" isVisible={true} animationInDuration={1000}>
                <h1 class='text-4xl font-bold wavy-underline'>{t("Skills")}</h1>
            </Animated>

            <div class='flex flex-row gap-4 flex-wrap justify-center mb-5 mt-3'>
                <SkillTab name={t("languages")} selected={selected} askills={skills} skills={languages} setSelected={setSelected} setSkills={setSkills} setVisible={setVisible}/>
                <SkillTab name={t("databases")} selected={selected} askills={skills} skills={db} setSelected={setSelected} setSkills={setSkills} setVisible={setVisible}/>
                <SkillTab name={t("frameworks")} selected={selected} askills={skills} skills={frameworks} setSelected={setSelected} setSkills={setSkills} setVisible={setVisible}/>
                <SkillTab name={t("tools")} selected={selected} askills={skills} skills={tools} setSelected={setSelected} setSkills={setSkills} setVisible={setVisible}/>
            </div>
